...
export default function AgreeCheck({ allCheck, ageCheck, serviceCheck, privacyCheck, marketingCheck, activeCheck, allBtnEvent, ageBtnEvent, serviceBtnEvent, privacyBtnEvent, marketingBtnEvent, activeBtnEvent, userData }) {
